...
public class ClientesB extends javax.swing.JInternalFrame {
    ...
    void mostrarclientes(String valor) {
        ...
        String Sql = "SELECT * FROM cliente WHERE CONCAT(cod_cli,nom_cli,ape_cli,dni_cli,dir_cli,not_cli,tip_cli,tel_cli) LIKE '%" + valor + "%'";
...
// TODO add your handling code here:
    String cod = "", nom="", ape="",dni="",dir="",tipo="";
    ...
    try {
        if (fila == -1) {
            ...
            dni = (String) tbclientes.getValueAt(fila, 3);
