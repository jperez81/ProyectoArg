...
public class ConsultasFacturas extends javax.swing.JInternalFrame {
    ...
    void cargartodasfacturas()
    {
        ...
        String []titulos={"Numero","Nom Ape","Tipo","SubTotal","IVA","Total","Fecha"};
    ...
    private void initComponents() {
        ...
        mnver.setText("Ver detalle de seleccion");
...
// TODO add your handling code here:
    ...
    detalle.setVisible(true);
        ...
        String tipo=tbfacturas.getValueAt(filasele, 2).toString();
        ...
        DetalleFactura.txtnomape.setText(cod);
        DetalleFactura.txtruc.setText(tipo);
        DetalleFactura.txtsub.setText(subtotal);
        DetalleFactura.txtigv.setText(iva);
